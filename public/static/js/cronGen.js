(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            inputElement = $("#" + options.cronInput);

            var cronTab = $("<ul/>", {"class": "nav nav-tabs", id: "CronGenTabs"});
            $('<li/>', {'class': 'nav-item',}).html($('<a id="SecondlyTab" data-val="Secondly" class="nav-link active" href="javascript:">秒</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="MinutesTab" data-val="Minutes" class="nav-link"  href="javascript:">分钟</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="HourlyTab" data-val="Hourly" class="nav-link" href="javascript:">小时</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="DailyTab" data-val="Daily" class="nav-link"  href="javascript:">日</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="MonthlyTab" data-val="Monthly" class="nav-link"  href="javascript:">月</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="WeeklyTab" data-val="Weekly" class="nav-link"   href="javascript:">周</a>')).appendTo(cronTab);
            $('<li/>', {'class': 'nav-item'}).html($('<a id="YearlyTab" data-val="Yearly" class="nav-link"  href="javascript:">年</a>')).appendTo(cronTab);

            cronTab.appendTo($(this));

            var tabContent = $("<div/>", {"class": "tab-content", id: "tabContent"});
            ...
            //选择选项
            $("#CronGenTabs a").click(function () {
                $("#CronGenTabs a").removeClass("active");
                $(this).addClass("active");
                var panelId = $(this).attr("data-val");
            ...
            $("#tabContent").find("input").change(function (e) {
                generate();
            }).focus(function (e) {
                generate();
            });
    ...
    var generate = function () {
        var activeTab = $("#CronGenTabs li a.active").prop("id");
        var results = "";
        switch (activeTab) {
            case "SecondlyTab":
